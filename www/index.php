...
if($_SERVER['REQUEST_URI'] == '/random') {
	$query  = "select id from bugdb where status!='Closed' and status!='Not a bug' and status!='Duplicate' and status!='Spam' and status!='Wont fix' and status!='No Feedback' and private!='Y' order by rand() limit 1";
